...
to draw-road
  let erasing? grey = [pcolor] of patch mouse-xcor mouse-ycor
  while [mouse-down?]
    [
...
to draw-exit
  let erasing? blue = [pcolor] of patch mouse-xcor mouse-ycor
  while [mouse-down?]
    [
      ask patch mouse-xcor mouse-ycor
      [
...
to place-tollbooth
  ...
  ask tollbooths
   [
     let prey one-of tollbooths-here
     if prey != nobody and prey != self
     [
       ask prey [die]
     ]
   ]
